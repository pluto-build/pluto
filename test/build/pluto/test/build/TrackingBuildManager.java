...
import build.pluto.dependency.database.MemoryDatabase;
...
public class TrackingBuildManager extends BuildManager {
  ...
  public TrackingBuildManager() {
    super(new LogReporting(), new MemoryDatabase<File, File>());
  }

  public TrackingBuildManager(IReporting reporting) {
    super(reporting, new MemoryDatabase<File, File>());
  }

  public <In extends Serializable, Out extends Output, B extends Builder<In, Out>, F extends BuilderFactory<In, Out, B>> BuildRequirement<Out> require(F factory, In input) throws IOException {
    return require(factory, input, true);
  }

  public <In extends Serializable, Out extends Output, B extends Builder<In, Out>, F extends BuilderFactory<In, Out, B>> BuildRequirement<Out> require(F factory, In input, boolean needBuildResult) throws IOException {
    requiredInputs.add(input);
    return super.require(new BuildRequest<>(factory, input), needBuildResult);
  }

  @Override
  public <In extends Serializable, Out extends Output, B extends Builder<In, Out>, F extends BuilderFactory<In, Out, B>> BuildRequirement<Out> require(BuildRequest<In, Out, B, F> buildReq, boolean needBuildResult) throws IOException {
